...
func NewServerInterfaceWithSentry(base ServerInterface, instance string) ServerInterfaceWithSentry {
...
func (_d ServerInterfaceWithSentry) _spanDecorator(span *sentry.Span, params, results map[string]interface{}) {
	for p := range params {
