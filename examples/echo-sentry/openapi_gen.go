...
type ServerInterface interface {
	...
	// (GET /hello/{name})
	SayHello(ctx echo.Context, name string) error
}
...
func (w *ServerInterfaceWrapper) SetGreeting(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "greeting", ctx.Param("greeting"), &greeting, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) SayHello(ctx echo.Context) error {
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.SayHello(ctx, name)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/hello/:name", wrapper.SayHello)
