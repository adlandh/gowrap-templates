...
func NewAppInterfaceWithSentry(base AppInterface, instance string, spanDecorator ...func(span *sentry.Span, params, results map[string]interface{})) AppInterfaceWithSentry {
...
func (_d AppInterfaceWithSentry) _defaultSpanDecorator(span *sentry.Span, params, results map[string]interface{}) {
	for p := range params {
